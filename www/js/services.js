...
.factory('SpoterEvents', ['$http', '$q', '_', 'appGlobals', 'DSCacheFactory', function($http, $q, _, appGlobals, DSCacheFactory) {

	var resource_endpoint = appGlobals.config.api.endpoint + "events";
